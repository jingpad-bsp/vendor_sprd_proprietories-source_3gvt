...
import com.spreadtrum.csvt.videophone.joou.UByte;
import com.spreadtrum.csvt.videophone.joou.UInteger;
...
class VideoSource {
    ...
    private void init(String dataSource, int videoType) {
        ...
        if (dataSource != null) {
            ...
            if (m_DataSource == null)
            {
                ...
                m_DataSource = new String(SystemProperties.get("ro.vendor.modem.tty"));
    ...
    int writeBuffer(byte[] data, int nLen) {
        ...
        synchronized (m_GetBuffer) {
            ...
            // data += nTemp;
            m_nDataEnd = (m_nDataEnd + nTemp) % m_nRingBufferSize;
    ...
    int read(ByteBuffer buffer) {
        ...
        nSize = readRingBuffer(m_readBuffer); // modify for Bug#202658 1169983
    ...
    private synchronized int readRingBuffer(byte[] data) {
